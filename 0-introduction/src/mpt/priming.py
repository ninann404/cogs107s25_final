"""
MPT Model for Lexical Priming Experiment
"""
import pandas as pd
import pymc as pm
import arviz as az
...
def fit_stroop_model(data, n_trials):
    """Fits the Stroop MPT model and returns the trace."""
...
# PD+G Model (Process Dissociation with Guessing)
#   Parameters:
...
def fit_pd_model(data, n_trials):
    """Fits the Process Dissociation MPT model and returns the trace."""
    pass
